...
| 6 | 2026-08-04 | 打地鼠竞速独立复审 | 竞速 UX 遗留两条：客人开局前看不到房主所选难度；结算后房主离开时客人等待界面缺少明确提示 | 进行中(tasks/2026-08-06-whackamole-race-cleanup) |
| 7 | 2026-08-04 | 竞速修复轮 P2 明确跳过（留痕） | 观战者（第三人）进房仍见空闲棋盘与「等待房主开始…」横幅，应短路游戏区（P2 按新纪律跳过须可追溯，下次触碰打地鼠时带上） | 进行中(tasks/2026-08-06-whackamole-race-cleanup) |
