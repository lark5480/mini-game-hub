...
| 14 | 2026-08-10 | 象棋 AI 加强 review（ai-enhancement） | 置换表/killer-history 启发与机动性/王安全评估项已实现（2026-08-10-xiangqi-ai-strength-boost）；剩余：开局库、王翼兵形细化、车半开放线等更多评估项，棋力上限仍受评估质量约束 | 部分完成(开局库已完成 2026-08-11-xiangqi-opening-book：7 条 UCCI 主变查表直出 + 构建期自检 + 随机变着，全难度与提示统一启用；王翼兵形细化/车半开放线保持待处理) |
