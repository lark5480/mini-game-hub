...
| 4 | 2026-08-04 | 打地鼠联机竞速 review（909cfed） | `copyText` 函数跨组件重复（WhackAMoleRaceView / TicTacToeOnlineView），建议抽到 `@/lib/clipboard.ts` | 进行中(PLAN.md 已立项，micro 任务) |
...
| 7 | 2026-08-04 | 竞速修复轮 P2 明确跳过（留痕） | 观战者（第三人）进房仍见空闲棋盘与「等待房主开始…」横幅，应短路游戏区（P2 按新纪律跳过须可追溯，下次触碰打地鼠时带上） | 待处理 |
